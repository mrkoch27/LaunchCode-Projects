...
let firstCodePoint; //  let firstCodePoint = inputString1.charCodeAt(0); console.log(inputString1.charCodeAt(0));
let thirdCodePoint; // let thirdCodePoint = inputString1.charCodeAt(3); console.log(inputString1.charCodeAt(3));

// Task 2
let wordFromCodePoints; // let wordFromCodePoints = [74, 97, 118, 97, 83, 99, 114, 105, 112, 116]; let characters = String.fromCharCode(wordFromCodePoints[0]) + String.fromCharCode(wordFromCodePoints[1]) + String.fromCharCode(wordFromCodePoints[2]) + String.fromCharCode(wordFromCodePoints[3]) + String.fromCharCode(wordFromCodePoints[4]) + String.fromCharCode(wordFromCodePoints[5]) + String.fromCharCode(wordFromCodePoints[6]) + String.fromCharCode(wordFromCodePoints[7]) + String.fromCharCode(wordFromCodePoints[8]) + String.fromCharCode(wordFromCodePoints[9]); console.log(characters);

// Task 3
let inputString2 = "Launch";
let swappedString; // let characters1 = console.log(inputString2.charCodeAt(0)); characters1 = console.log(inputString2.charCodeAt(1)); characters1 = console.log(inputString2.charCodeAt(2)); characters1 = console.log(inputString2.charCodeAt(3)); characters1 = console.log(inputString2.charCodeAt(4)); characters1 = console.log(inputString2.charCodeAt(5)); let swappedString = [76, 97, 117, 110, 99, 104]; newString = String.fromCharCode(swappedString[0]) + String.fromCharCode(swappedString[1]) + String.fromCharCode(swappedString[2]) + String.fromCharCode(swappedString[3]) + String.fromCharCode(swappedString[4]) + String.fromCharCode(swappedString[5]); console.log(newString);
